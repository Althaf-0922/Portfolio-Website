...
// === Awesome Cursor Script ===
(function(){
  if (window._hasAwesomeCursor) return;
  window._hasAwesomeCursor = true;

  const cursor = document.createElement('div');
  cursor.className = 'cursor';
  cursor.innerHTML = `
    <div class="cursor__blob"></div>
    <div class="cursor__ring"></div>
    <div class="cursor__dot"></div>
    <div class="cursor__line"></div>
  ...
  const hoverSelectors = 'a, button, input, textarea, select, [data-cursor-label]';
